...
import { Terminal, useUpdateTerminal } from '@/hooks/useTerminals';
  ...
  useEffect(() => {
    if (terminal) {
      form.reset({
        ...
        site_admin_name: terminal.site_admin_name || '',
        connection_method: terminal.connection_method,
      });
    }
  }, [terminal, form]);
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex justify-end space-x-2 pt-4">
              ...
              <Button type="submit" disabled={updateTerminal.isPending}>
                {updateTerminal.isPending ? 'Updating...' : 'Update Terminal'}
              </Button>
            </div>
          </form>
        </Form>
