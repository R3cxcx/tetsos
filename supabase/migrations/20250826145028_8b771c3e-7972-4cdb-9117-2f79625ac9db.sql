-- Update validate_sequence_ids to enforce EXACT padding digits and use Postgres-compatible regex
...
BEGIN
  ...
  -- EXACT padding: numeric part must be exactly padding digits (leading zeros are just part of those digits)
  v_digit_part := CASE
